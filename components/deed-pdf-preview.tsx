      ...
      <div className="m-0 p-0 b-0" ref={targetRef}>
        <div className={`flex h-[1551px]`}>
          <div className="mt-[4.5in] mb-[1.5in] mx-[1in] flex-1 flex flex-col items-center gap-4">
            <div className="flex flex-col items-center">
              ...
              <p>এম আর এ সনদ নং- ০০৭১১-০০০২৭-০০০০৩০৩, মোবাইল:০১৭১১-৮১৩৪৭০</p>
        ...
        <div className={`flex h-[1551px]`}>
          <div className="mt-[4.5in] mb-[1.5in] mx-[1in] flex-1 flex flex-col items-center gap-4">
            ...
            <ul className="text-justify">
              ...
              <li>
                ৫. ঋণের কিস্তির সংখ্যাঃ ১ (এক) টি, মেয়াদ শেষে এককালিন পরিশোধ
                যোগ্য।
              </li>
              <li>
              ...
              <li>
                ...
                অর্থ উত্তোলন করলে ২য় পক্ষ কোন প্রকার মুনাফা পাবেন না। ২য় পক্ষ
                যদি উক্ত সময়ে মাসিক মুনাফা গ্রহন করে, সে ক্ষেত্রে গ্রহনকৃত
                মুনাফার সমপরিমাণ অর্থ ঋণদাতার (২য় পক্ষ) মূল অর্থের সাথে সমন্বয়
                করে অবশিষ্ট অর্থ ১ম পক্ষ, ২য় পক্ষকে ফেরত দিবে। <br /> অথবা{" "}
                <br />
              ...
              <li>
                ৮. ঋণদাতা (2য় পক্ষ) তার প্রদানকৃত অর্থ ফেরত নেয়ার জন্য কমপক্ষে
                ১০ (দশ) কর্ম দিবস পূর্বে সংস্থার সংশ্লিষ্ট অফিসের মাধ্যমে
                নির্বাহী পরিচালক বরাবর লিখিত আবেদন করতে হবে।
              </li>
              <li>
                ৯. ২য় পক্ষ (ঋণদাতা) কে ঋণের ঋণের মূল অর্থ গ্রহনের জন্য সংশ্লিষ্ট
        ...
        <div className={`flex h-[1551px]`}>
          <div className="mt-[4.5in] mb-[1.5in] mx-[1in] flex-1 flex flex-col items-center gap-4">
            <ul className="text-justify">
              <li>
                ১০. ঋণের মুল অর্থ ফেরতের সময় অব্যশই ঋণদাতা (2য় পক্ষ) ঋণের
                সংক্রান্ত মুল রশিদ ও চুক্তিনামার মুল কপি জমা নিতে হবে।
              </li>
              <li>
                ...
                স্থিতি থাকে অথবা ২য় পক্ষকে ১ম পক্ষ ঝুকি মনে করলে ২য় পক্ষের
                চুক্তিকৃত টাকা থেকে ১ম পক্ষের সমস্ত পাওনা টাকা কর্তন পূর্বক
                সমন্বয় করে নিতে পারবে।
              </li>
              <li>
                ১২. ঋণ দাতা (২য় পক্ষ) ১ম পক্ষ-কে ঋণ দেয়ার পর যদি মৃত্যুবরণ করে,
            ...
            <ul className="text-justify">
              ...
              <li>
                ১৪. ২য় পক্ষ (ঋণ দাতা) যদি আইনগত ভাবে অপরাধী প্রামণিত হয় অথবা
        ...
        <div className={`flex h-[1551px]`}>
          <div className="mt-[4.5in] mb-[1.5in] mx-[1in] flex-1 flex flex-col items-center gap-4">
            <p>
              ...
              পূর্বক চুক্তিপত্রে সহি স্বাক্ষর সম্পাদন করিলাম।
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex-1 border rounded p-2">
                <p>১ম পক্ষ (ঋণ গ্রহীতা)</p>
                <p>অলটারনেটিভ ডেভেলপমেন্ট ইনিসিয়েটিভ (এডিআই) পক্ষে</p>
                <p>স্বাক্ষর:</p>
                <p>সীল</p>
                <br />
              ...
              <div className="flex-1 border rounded p-2">
                <p> ১ম পক্ষের (ঋনগ্রহিতা) স্বাক্ষী ১:</p>
                <p>অলটারনেটিভ ডেভেলপমেন্ট ইনিসিয়েটিভ (এডিআই) পক্ষে</p>
                <p>স্বাক্ষর:</p>
                <p>সীল</p>
                <br />
              ...
              <div className="flex-1 border rounded p-2">
                <p> ১ম পক্ষের (ঋনগ্রহিতা) স্বাক্ষী ২:</p>
                <p>অলটারনেটিভ ডেভেলপমেন্ট ইনিসিয়েটিভ (এডিআই) পক্ষে</p>
                <p>স্বাক্ষর:</p>
                <br />
                <p>সীল</p>
              ...
              <div className="flex-1 border rounded p-2">
                <p> ২য় পক্ষের (ঋনদাতা) স্বাক্ষী ২:</p>
                <p>নাম:</p>
                <p>স্বাক্ষর:</p>
                <p>ঠিকানা:</p>
              </div>
