  ...
  return (
    <div className="space-y-4">
      ...
      <div className="m-0 p-0" ref={targetRef}>
        <div
          className={`flex flex-col gap-4 items-center justify-center h-[1332px] px-20`}
        >
        ...
        >
          ...
          <ol className="list-decimal list-inside text-justify">
            ...
            <li>
              6প্রথম পক্ষ (ঋণ গ্রহীতা) প্রতি মাসে ঋণের মেয়াদ ০১ (এক) মাস
              উর্ত্তীণ হওয়ার পরবর্তী সপ্তাহের প্রথম কর্মদিবসে দ্বিতীয় পক্ষের (ঋণ
              দাতা) সংশ্লিষ্ট --------------------------------- ব্যাংক পিএলসি,
              --------------------শাখার, হিসাব নং
              -------------------------------মাধ্যমে মুনাফার টাকা প্রদান করবে।
            </li>
            <li>
              ঋণচুক্তির মেয়াদ ০৩ মাস উত্তীর্ণ হওয়ার আগে ঋণচুক্তি বাতিল করে অর্থ
              উত্তোলন করলে ২য় পক্ষ কোন প্রকার মুনাফা পাবেন না। ২য় পক্ষ যদি উক্ত
              সময়ে মাসিক মুনাফা গ্রহন করে, সে ক্ষেত্রে গ্রহনকৃত মুনাফার সমপরিমাণ
              অর্থ ঋণদাতার (২য় পক্ষ) মূল অর্থের সাথে সমন্বয় করে অবশিষ্ট অর্থ ১ম
              পক্ষ, ২য় পক্ষকে ফেরত দিবে। <br /> অথবা <br />
              ঋণচুক্তির মেয়াদ উর্ত্তীন হওয়ার আগে ঋণচুক্তি বাতিল করে অর্থ উত্তোলন
              করলে সে ক্ষেত্রে ঋণের মেয়াদ ১ (এক) বছর পুর্ন করলে ১২% এবং ঋণের
              মেয়াদ ১ (এক) বছরের কম হলে ৬% হারে মুনাফা প্রদান করতে হবে। (06 বছরে
              দিগুন ঋণের ক্ষেত্রে )
            </li>
            <li>
              ঋণদাতা (2য় পক্ষ) তার প্রদানকৃত অর্থ ফেরত নেয়ার জন্য কমপক্ষে ১০
              (দশ) কর্ম দিবস পূর্বে সংস্থার সংশ্লিষ্ট অফিসের মাধ্যমে নির্বাহী
              পরিচালক বরাবর লিখিত আবেদন করতে হবে।
            </li>
            <li>
              ২য় পক্ষ (ঋণদাতা) কে ঋণের ঋণের মূল অর্থ গ্রহনের জন্য সংশ্লিষ্ট
              অফিসে নিজে অথবা ক্ষমতা প্রাপ্ত ব্যক্তিকে উপস্থিত হয়ে চেক গ্রহণ
              করতে হবে।
            </li>
            <li>
              ঋণের মুল অর্থ ফেরতের সময় অব্যশই ঋণদাতা (2য় পক্ষ) ঋণের সংক্রান্ত
              মুল রশিদ ও চুক্তিনামার মুল কপি জমা নিতে হবে।
            </li>
            <li>
              ২য় পক্ষ চুক্তি বাতিল করে মূল টাকা ফেরত নিতে চাইলে, ১ম পক্ষের নিকট
              থেকে ২য় পক্ষের জিম্মায় যদি কোন ঋণ থাকে এবং সেই ঋণের যদি কোন স্থিতি
              থাকে অথবা ২য় পক্ষকে ১ম পক্ষ ঝুকি মনে করলে ২য় পক্ষের চুক্তিকৃত টাকা
              থেকে ১ম পক্ষের সমস্ত পাওনা টাকা কর্তন পূর্বক সমন্বয় করে নিতে
              পারবে।
            </li>
            <li>
              2য় পক্ষ (ঋণদাতা) ও তার নমিনি উভয় মৃত্যবরন করলে মৃত ব্যক্তিগনের
              মৃত্যুসনদ ও ওয়ারিশ সনদ উপস্থাপন স্বাপক্ষে বৈধ ওয়ারিশদের ঋণের সমুদয়
              অর্থ দেয়া যাবে। তবে আইনগত সমস্যা থাকলে সমাধান না হওয়া পর্যন্ত উক্ত
              ঋণের অর্থ ফেরত দেয়া স্থগিত থাকবে।
            </li>
            <li>
              ২য় পক্ষ (ঋণ দাতা) যদি আইনগত ভাবে অপরাধী প্রামণিত হয় অথবা আদালত
              কর্তৃক দেউলিয়া ঘোষিত হয় অথবা সামাজিকভাবে ক্ষতিকর কাজে লিপ্ত হয় তবে
              ১ম পক্ষ তৎক্ষনাৎ তার সাথে চুক্তি বাতিল করতে পারবে। এক্ষেত্রে
              চুক্তির তারিখ থেকে চুক্তি বাতিল এর তারিখ পর্যন্ত মেয়াদকাল ৬ (ছয়)
              মাসের কম হলে কোন প্রকার মুনাফা প্রদান করা হবে না। যদি ৬-১২ মাস বা
              ৬ মাসের উর্দ্ধে কিন্তু ১ (এক) বছরের কম সময় হয় তবে প্রতি পূর্ণ মাস
              হিসাব করে ৬% হারে মুনাফা প্রদান করা হবে এবং চুক্তি বাতিল পূর্বক
              দেনা-পাওনা মূল অর্থের সাথে সমন্বয় পূর্বক অবশিষ্ট অর্থ ফেরত প্রদান
              করা হবে।
            </li>
            <li>
              ঋণ দাতা (২য় পক্ষ) ১ম পক্ষ-কে ঋণ দেয়ার পর যদি মৃত্যুবরণ করে, সে
              ক্ষেত্রে আইনগত কোন জটিলতা না থাকলে নিম্ন ছক অনুযায়ী নমিনি
