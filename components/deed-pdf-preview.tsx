...
export interface DeedPdfPreviewHandle {
...
const DeedPdfPreview = forwardRef<DeedPdfPreviewHandle, DeedPdfPreviewProps>(
  ({ deed }, ref) => {
    const { toPDF, targetRef } = usePDF({
      filename: `deed-${deed.deed_custom_id}.pdf`,
    ...
    return (
      <div className="space-y-4 min-w-[942px] max-w-[980px]">
        <div className="m-0 p-0 b-0" ref={targetRef}>
          <div
            className={`flex xl:h-[1551px] h-[1549.76px] w-[942px] relative`}
          >
            <div className="absolute top-5 right-8">গ্রাহক কপি</div>
            <div className="mt-[4.5in] mb-[1.5in] mx-[1in] flex-1 flex flex-col items-center gap-4">
              <div className="flex flex-col items-center">
                ...
                <br />
                <p>
                  চুক্তিপত্র নং-{convertToBengaliNumber(deed.deed_custom_id)}
                </p>
              </div>
              <p>
                অদ্য{" "}
          ...
          <div className={`flex xl:h-[1551px] h-[1549.76px] w-[942px]`}>
            <div className="mt-[4.5in] mb-[1.5in] mx-[1in] flex-1 flex flex-col items-center gap-4">
              <p className="text-justify">
                ...
                {deed.first_side_representative.zone_name} জোন এ উপস্থিত হয়ে
                অদ্য-
                {convertToBengaliNumber(
                  new Date(deed.agreementdate)
                    .toLocaleDateString("en-GB")
              ...
              <ul className="text-justify">
                ...
                <li>
                  ৩. ঋণের মেয়াদ হবে{" "}
                  {convertToBengaliNumber(deed.tenure_of_loan)} বছর।
                </li>
                <li>
                  ৪. ঋণের মেয়াদ উত্তীর্ণ হওয়ার পর উভয় পক্ষ চাইলে উক্ত ঋন নবায়ন
                  করা যাবে।
                </li>
                <li>
                ...
                <li>
                  ৭. ঋণচুক্তির মেয়াদ ০৩ মাস উত্তীর্ণ হওয়ার আগে ঋণচুক্তি বাতিল
                  করে অর্থ উত্তোলন করলে ২য় পক্ষ কোন প্রকার মুনাফা পাবে না। ২য়
                  পক্ষ যদি উক্ত সময়ে মাসিক মুনাফা গ্রহন করে, সে ক্ষেত্রে
                  গ্রহনকৃত মুনাফার সমপরিমাণ অর্থ ঋণদাতার (২য় পক্ষ) মূল অর্থের
                  সাথে সমন্বয় করে অবশিষ্ট অর্থ ১ম পক্ষ, ২য় পক্ষকে ফেরত দিবে।{" "}
          ...
          <div className={`flex xl:h-[1551px] h-[1549.76px] w-[942px]`}>
            <div className="mt-[4.5in] mb-[1.5in] mx-[1in] flex-1 flex flex-col items-center gap-4">
              <ul className="text-justify">
                ...
                <li>
                  ১১. ২য় পক্ষ চুক্তি বাতিল করে মূল টাকা ফেরত নিতে চাইলে, ১ম
                  পক্ষের নিকট থেকে ২য় পক্ষের জিম্মায় যদি কোন ঋণ থাকে এবং সেই
                  ঋণের যদি কোন স্থিতি থাকে অথবা ২য় পক্ষকে ১ম পক্ষ ঝুঁকি মনে করলে
                  ২য় পক্ষের চুক্তিকৃত টাকা থেকে ১ম পক্ষের সমস্ত পাওনা টাকা কর্তন
                  পূর্বক সমন্বয় করে নিতে পারবে।
                </li>
                <li>
                  ১২. ঋণদাতা (২য় পক্ষ) ১ম পক্ষ-কে ঋণ দেয়ার পর যদি মৃত্যুবরণ করে,
                  সে ক্ষেত্রে আইনগত কোন জটিলতা না থাকলে নিম্ন ছক অনুযায়ী নমিনি
                  প্রদানকৃত অর্থ ফেরত পাবে। যদি নমিনি তার চুক্তি চলমান রাখতে
                  চান, তবে সংস্থার সাথে নতুন চুক্তি সম্পাদন করতে হবে।
                </li>
              </ul>
              <table>
                <thead>
              ...
              <ul className="text-justify">
                ...
                <li>
                  ...
                  লিপ্ত হয় তবে ১ম পক্ষ তৎক্ষনাৎ তার সাথে চুক্তি বাতিল করতে
                  পারবে। এক্ষেত্রে চুক্তির তারিখ থেকে চুক্তি বাতিল এর তারিখ
                  পর্যন্ত মেয়াদকাল ৬ (ছয়) মাসের কম হলে কোন প্রকার মুনাফা প্রদান
                  করা হবে না। যদি ৬-১২ মাস বা ৬ মাসের উর্দ্ধে কিন্তু ১ (এক)
                  বছরের কম সময় হয় তবে প্রতি পূর্ণ মাস হিসাব করে ৬% হারে মুনাফা
                  প্রদান করা হবে এবং চুক্তি বাতিল পূর্বক দেনা-পাওনা মূল অর্থের
                  সাথে সমন্বয় পূর্বক অবশিষ্ট অর্থ ফেরত প্রদান করা হবে।
                </li>
              </ul>
            </div>
          </div>
          <div className={`flex xl:h-[1551px] h-[1549.76px] w-[942px]`}>
            <div className="mt-[4.5in] mb-[1.5in] mx-[1in] flex-1 flex flex-col items-center gap-4">
              <p className="text-justify">
                ...
                মস্তিষ্কে কারো দ্বারা প্ররোচিত না হয়ে এই চুক্তির মর্মার্থ
                অনুধাবন পূর্বক চুক্তিপত্রে সহি স্বাক্ষর সম্পাদন করলাম।
              </p>
          ...
          <div
            className={`flex xl:h-[1551px] h-[1549.76px] w-[942px] relative`}
          >
            <div className="absolute top-5 right-8">অফিস কপি</div>
            <div className="mt-[0.5in] mb-[0.5in] mx-[1in] flex-1 flex flex-col items-center gap-4 ">
              <div className="flex flex-col items-center">
                <h1 className="text-2xl font-bold">
                  অলটারনেটিভ ডেভেলপমেন্ট ইনিসিয়েটিভ (এডিআই)
                </h1>
          ...
          <div className={`flex xl:h-[1551px] h-[1549.76px] w-[942px]`}>
            <div className="mt-[0.5in] mb-[0.5in] mx-[1in] flex-1 flex flex-col items-center gap-4 relative">
              <ul className="text-justify">
                <li>
                  <div className="text-center">অথবা</div>
                  ঋণচুক্তির মেয়াদ উর্ত্তীন হওয়ার আগে ঋণচুক্তি বাতিল করে অর্থ
...
DeedPdfPreview.displayName = "DeedPdfPreview";

export default DeedPdfPreview;
